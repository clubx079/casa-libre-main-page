...
const DICT = {
  ...
  pt: {
    ...
    heroStats: [['3', 'países no ar'], ['8', 'mercados-alvo'], ['+430M', 'habitantes na região']],
    ...
    contCards: [
      { t: 'Já em operação', d: 'Paraguai e Bolívia já estão no ar. Uruguai, em acesso antecipado. Anúncios reais, compradores reais e conversas com proprietários todos os dias. Um produto no mercado, não um plano.' },
    ...
    contBig: [['3', 'mercados no ar'], ['5', 'lançamentos programados'], ['+430M', 'habitantes na região'], ['1', 'uma só marca em toda a região']],
    contFine: 'Argentina, Brasil e Chile são os próximos; depois, Peru e Venezuela. Cada lançamento financia o seguinte.',
    mapTitle: 'Oito países. Três já no ar.',
